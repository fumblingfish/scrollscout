...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.resolveTargetPoint = exports.notificationOrder = exports.enchancedPins = exports.axisPair = exports.someAxis = exports.targetPointPair = exports.targetPoint = undefined;
	...
	var enchancedPins = exports.enchancedPins = function enchancedPins(pinObj) {
	   var pT = pinObj.pT;
	   var nT = pinObj.nT;
	...
	var resolveTargetPoint = exports.resolveTargetPoint = function resolveTargetPoint(pState, nState) {
	   return function (pin) {
	      var predicate = _predicates.directionPredicates[pin._direction];
	      var prevStatePair = axisPair(pin._axis, pState.view, pState.scene);
	      var nextStatePair = axisPair(pin._axis, nState.view, nState.scene);
	...
	function scout(obsvr, view, scene, optns) {
	   ...
	   var updateScout = function updateScout() {
	      ...
	      var resolvedPins = pinSubscribers.map(resolveTargetPoint(prevState, nextState));
	      var resolvedPinsToNotify = resolvedPins.filter(function (resolvedPin) {
	         return resolvedPin.notify;
	      });
	      var pinsToNotify = resolvedPinsToNotify.map(enchancedPins);
	      var ordered = pinsToNotify.length > 1 ? notificationOrder(pinsToNotify) : pinsToNotify;
	
	      ordered.forEach(function (resolvedPin) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var directionPredicates = exports.directionPredicates = (_directionPredicates = {}, _defineProperty(_directionPredicates, _constants.FORWARD, nextDescendPrev), _defineProperty(_directionPredicates, _constants.BACKWARD, nextAscendPrev), _directionPredicates);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (viewElement, sceneElement, scout) {
	   ...
	   var startUpdater = function startUpdater(exposeUpdateFn) {
	      updateFn = (0, _common.isFunction)(exposeUpdateFn) ? exposeUpdateFn(updateHandler) : updateHandler;
	...
	var _contextDomDebug = __webpack_require__(10);
	
	var _common = __webpack_require__(5);
	
	var _contextDomEnv = __webpack_require__(11);
	   ...
	   return {
	      update: function update(nState) {
	         pins.forEach(function (pin) {
	            ...
	            var axisStyle = propMap[pin._axis];
	            var nextStatePair = (0, _scout.axisPair)(pin._axis, nState.view, nState.scene);
